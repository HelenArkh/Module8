...
namespace Module8
{
    class Program
    {
        ...
        {
            FileInfo fi = new FileInfo(@"D:\VS_Projects\Module8\Module8\Module8\Program.cs"); // Укажем путь
...
// Время последнего запуска: 18.01.2021 21:23:55
// Время последнего запуска: 18.01.2021 21:25:26
// Время запуска: 18.01.2021 21:27:16
